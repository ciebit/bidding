...
class Sql implements Database
{
    ...
    private function build(array $data): Bidding
    {
        ...
        $bidding = new Bidding(
            ...
            (string) $data[self::COLUMN_NUMBER],
            (string) $data[self::COLUMN_SLUG],
            (string) $data[self::COLUMN_COMMITTEE_ID],
            ...
            (string) $data[self::COLUMN_RESPONSIBLE_AWARD_ID],
            (string) $data[self::COLUMN_RESPONSIBLE_APPROVAL_ID],
